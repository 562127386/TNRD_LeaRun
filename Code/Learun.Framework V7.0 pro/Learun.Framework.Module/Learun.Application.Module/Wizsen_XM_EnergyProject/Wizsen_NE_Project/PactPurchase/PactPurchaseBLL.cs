...
namespace Wizsen_XM_EnergyProject.Wizsen_NE_Project
{
    ...
    /// 描 述：采购设备合同
    /// </summary>
    public class PactPurchaseBLL : PactPurchaseIBLL
    {
        private PactPurchaseService pactPurchaseService = new PactPurchaseService();
        ...
        public DataTable GetList(string queryJson)
        {
            try
            {
                return pactPurchaseService.GetList(queryJson);
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<XM_Pact_PurchaseEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return pactPurchaseService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public IEnumerable<XM_Facility_BaseEntity> GetXM_Facility_BaseList(string keyValue)
        {
            try
            {
                return pactPurchaseService.GetXM_Facility_BaseList(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public XM_Pact_PurchaseEntity GetXM_Pact_PurchaseEntity(string keyValue)
        {
            try
            {
                return pactPurchaseService.GetXM_Pact_PurchaseEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public XM_Facility_BaseEntity GetXM_Facility_BaseEntity(string keyValue)
        {
            try
            {
                return pactPurchaseService.GetXM_Facility_BaseEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                pactPurchaseService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, XM_Pact_PurchaseEntity entity, List<XM_Facility_BaseEntity> xM_Facility_BaseList)
        {
            try
            {
                pactPurchaseService.SaveEntity(keyValue, entity, xM_Facility_BaseList);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
