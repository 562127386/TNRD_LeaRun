...
namespace Wizsen_TNRD_EnergyProject.Wizsen_TNRD_Project
{
    ...
    /// 描 述：设备列表
    /// </summary>
    public class FacilityBaseBLL : FacilityBaseIBLL
    {
        private FacilityBaseService facilityBaseService = new FacilityBaseService();
        ...
        public IEnumerable<TNRD_Facility_BaseEntity> GetList( string queryJson )
        {
            try
            {
                return facilityBaseService.GetList(queryJson);
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<TNRD_Facility_BaseEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return facilityBaseService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public TNRD_Facility_BaseEntity GetEntity(string keyValue)
        {
            try
            {
                return facilityBaseService.GetEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                facilityBaseService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, TNRD_Facility_BaseEntity entity)
        {
            try
            {
                facilityBaseService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
