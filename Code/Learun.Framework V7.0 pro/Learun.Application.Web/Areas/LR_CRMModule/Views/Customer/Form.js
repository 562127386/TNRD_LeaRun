...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            // 客户级别
            $('#F_CustLevelId').lrDataItemSelect({ code: 'Client_Level', maxHeight: 260 });
            // 客户类别
            $('#F_CustTypeId').lrDataItemSelect({ code: 'Client_Sort', maxHeight: 260 });
            // 客户程度
            $('#F_CustDegreeId').lrDataItemSelect({ code: 'Client_Degree', maxHeight: 260 });
            //跟进人员
            ...
            //公司行业
            $('#F_CustIndustryId').lrDataItemSelect({ code: 'Client_Trade', maxHeight: 260 });
