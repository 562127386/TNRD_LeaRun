...
(function ($, learun) {
    ...
    var page = {
        init: function () {
            ...
            // 打开首页模板
            learun.frameTab.open({ F_ModuleId: '0', F_Icon: 'fa fa-desktop', F_FullName: '我的桌面', F_UrlAddress: '/Home/AdminDesktop',isActive:true }, true);
            //learun.frameTab.open({ F_ModuleId: '1', F_Icon: 'fa fa-desktop', F_FullName: '项目流程事记', F_UrlAddress: '/Wizsen_NE_Project/AdjunctDatails/Browse', isActive: false }, true);
            learun.frameTab.focus(0);
