...
- (enh #1042, #860): Fixes to initial preview delete (related to #1034).
...
- (bug #1060): Correct image dimension validation to consider non JPEG images.
...
- (enh #950, #960): Add responsive support for Krajee Explorer theme for mobile devices.
...
- (enh #760): Correct Romanian Translations.
...
- (enh #560): Error alert box and preview thumbnail styling enhancements.
...
- (enh #360): Minor enhancements in validating preview and progress bar display.
...
- (enh #609): Fixes for older browsers.
- (enh #608): Better check for `data.error` being empty.
- (enh #607): Allow setting thumbnail frame css class and attributes via `initialPreviewConfig`.
- (enh #605): Implement better cleanup of memory with `revokeObjectURL`.
- (enh #603): Validate only files to be dragged and dropped.
- (enh #602): Add Greek (el) translations.
...
- (enh #260): More correct initial preview delete reset.
...
- (enh #60): Enhanced generic support for more preview formats (audio, video, html, flash, and other objects).
