        ...
        initGrid: function () {
            $('#gridtable').lrAuthorizeJfGrid({
                ...
                headData: [
                    ...
                    {
                        label: '创建时间', name: 'F_CreateDate', width: 160, align: 'center'
                    },
                    {
                        label: '创建人', name: 'F_CreateUserName', width: 160, align: 'center'
                    },
                    {
                    ...
                    { label: "角色描述", name: "F_Description", index: "F_Description", width: 600, align: "left" }
                ],
                isPage: true,
                reloadSelected: true,
                mainId: 'F_RoleId'
